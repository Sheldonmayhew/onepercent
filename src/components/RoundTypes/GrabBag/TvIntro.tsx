  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{
          scale: { repeat: Infinity, duration: 1.2, ease: 'easeInOut', delay: 0.5 },
          rotate: { type: 'spring', stiffness: 260, damping: 18, delay: 0.3 },
        }}
      >
        🎒
      </motion.div>

      {/* Round name — emerald accent */}
      <motion.h1
        className="font-display text-4xl md:text-5xl font-bold text-emerald-400 tracking-wider mb-2"
