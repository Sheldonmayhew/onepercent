...
export default function TvIntro({ roundIndex, totalRounds, difficulty, points, roundName, tagline }: TvIntroProps) {
  ...
  return (
    ...
    >
      ...
      {/* Round name */}
      <motion.h1
        className="font-display text-4xl md:text-5xl font-bold text-neon-green tracking-wider mb-2"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ type: 'spring', stiffness: 180, damping: 16, delay: 0.4 }}
      >
        {roundName || 'POINT BUILDER'}
      </motion.h1>
      ...
      >
        {tagline || 'Stack your points, build your lead!'}
      </motion.p>
